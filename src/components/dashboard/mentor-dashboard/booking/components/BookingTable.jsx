...
const BookingTable = ({ tabItems = [], filterData = { results: [] }, setShowModal, setBookingData, update, setUpdate }) => {
                ...
                <tbody>
                  {filterData.results.map((item) => (
                    <tr key={item.booking_id}>
                      ...
                      {(isVendor || isAdmin) && (
                        <td>{item?.type === "venue" ? "Internship" : item?.type === "vendor" ? "Job" : "N/A"}</td>
                      )}
                      ...
                      {(isVenue || isAdmin) && (
                        <td>{item?.type === "venue" ? item?.venue_name : item?.vendor_name}</td>
                      )}
